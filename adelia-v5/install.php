...
/**
 * Ensure all needed directories exist (db, res, src, thumb).
 * You can add or remove directories as needed for your setup.
 */
$directories = [
    __DIR__ . '/db',
    __DIR__ . '/res',
...
foreach ($directories as $dir) {
    ...
    if (!is_writable($dir)) {
        exit("Directory $dir is not writable. Fix permissions or create it manually.");
    }
}

define('CHESSIB_DBNAME', __DIR__ . '/db/chessib.db');
...
// Set permissions on the database file if necessary (on Windows this may not matter)
